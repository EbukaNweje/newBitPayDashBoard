...
const Payment = () => {
    ...
    const [state, setState] = useState({
        value: `${paymentname === "BITCOINP PAYMENT"? ("bc1q0vwtjgewllpackvg86ps4thxlzkdp9flt7jc25"): paymentname === "ETHEREUM PAYMENT"? ("0x51C9A181FcAdcE7E4704db79a876A4B84f4daBA1"): paymentname ==="USDT PAYMENT"? ("0xd4B4E16d815C062F395AD76108a87C822b39b16c"):"Chosse a Payment Method"}`,
        copied: false,
      });
